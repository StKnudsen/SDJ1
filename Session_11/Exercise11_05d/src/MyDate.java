...
public class MyDate
{
  ...
  {
    setAll(obj.day, obj.month, obj.year);
  }
  ...
  public int yearsBetween(MyDate other)
  {
    ...
    yearsBetween = biggestDate.year - smallestDate.year;

    if (smallestDate.month > biggestDate.month)
      yearsBetween--;

    if (smallestDate.month == biggestDate.month && smallestDate.day < biggestDate.day)
      yearsBetween--;
  ...
  public MyDate copy()
  {
    ...
    copy = new MyDate(day, month, year);
  ...
  public int daysBetween(MyDate other)
  {
    ...
    while (!smallestDate.equals(biggestDate))
    {
      daysBetween++;
      smallestDate.stepForwardOneDay();
    }
